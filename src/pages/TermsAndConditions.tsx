...
const TermsAndConditions: React.FC = () => (
  <div className="max-w-3xl mx-auto px-4 py-12 text-gray-800">
    ...
    <h3 className="text-xl font-semibold mt-8 mb-2">Responsible Use and Conduct</h3>
    <p className="mb-4">By visiting our website and accessing the information, resources, services, products, and tools we provide for you, either directly or indirectly (hereafter referred to as 'Resources'), you agree to use these Resources only for the purposes intended as permitted by:</p>
    ...
    <p className="mb-4">Wherein, you understand that:</p>
    <ol className="list-decimal pl-6 mb-4 space-y-2">
      ...
      <li>We do not assume any liability for any content posted by you or any other 3rd party users of our website. However, any content posted by you using any open communication tools on our website, provided that it doesn't violate or infringe on any 3rd party copyrights or trademarks, and as such, gives us a perpetual, irrevocable, worldwide, royalty-free, exclusive license to reproduce, modify, adapt, translate, publish, publicly display and/or distribute as we see fit. This only refers and applies to content posted via open communication tools as described, and does not refer to information that is provided as part of the registration process, necessary in order to use our Resources. All information provided as part of our registration process is covered by our Privacy Policy.</li>
      <li>We reserve the right to take over the exclusive defense of any claim for which we are entitled to indemnification under this User Agreement. In such event, you shall provide us with such cooperation as is reasonably requested by us.</li>
    </ol>
    <h3 className="text-xl font-semibold mt-8 mb-2">Privacy</h3>
    ...
    <h3 className="text-xl font-semibold mt-8 mb-2">Limitation of Warranties</h3>
    <p className="mb-4">By using our website, you understand and agree that all Resources we provide are 'as is' and 'as available'. This means that we do not represent or warrant to you that:</p>
    <ol className="list-decimal pl-6 mb-4 space-y-2">
    ...
    <p className="mb-4">Furthermore, you understand and agree that:</p>
    <ol className="list-decimal pl-6 mb-4 space-y-2" start={5}>
      ...
      <li>No information or advice, whether expressed, implied, oral or written, obtained by you through any Resources we provide shall create any warranty, guarantee, or conditions of any kind, except for those expressly outlined in this User Agreement.</li>
    </ol>
    <h3 className="text-xl font-semibold mt-8 mb-2">Limitation of Liability</h3>
    <p className="mb-4">In conjunction with the Limitation of Warranties as explained above, you expressly understand and agree that any claim against us shall be limited to the amount you paid, if any, for use of products and/or services. We will not be liable for any direct, indirect, incidental, consequential or exemplary loss or damages which may be incurred by you as a result of using our Resources, or as a result of any changes, data loss or corruption, cancellation, loss of access, or downtime to the full extent that applicable limitation of liability laws apply.</p>
    <h3 className="text-xl font-semibold mt-8 mb-2">Termination of Use</h3>
    ...
    <h3 className="text-xl font-semibold mt-8 mb-2">Governing Law</h3>
    <p className="mb-4">Any action to enforce this User Agreement shall be brought in the Federal or State courts located in India, Karnataka. You hereby agree to personal jurisdiction by such courts, and waive any jurisdictional, venue, or inconvenient forum objections to such courts.</p>
  </div>
);
